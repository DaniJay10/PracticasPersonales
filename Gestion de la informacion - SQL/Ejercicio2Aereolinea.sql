...
CREATE TABLE Pasajero(
        ...
        PRIMARY KEY(Cedula),
        FOREIGN KEY(Cedula) REFERENCES Persona (Cedula)),
        FOREIGN KEY(CedulaRecepcionista) REFERENCES Recepcionista(Cedula));
...
CREATE TABLE Equipaje(
        ...
        Tipo VARCHAR(10),
        PRIMARY(IDequipaje),
        FOREIGN KEY(CedulaPasajero) REFERENCES Pasajero (Cedula),
        FOREIGN KEY(IDcarro) REFERENCES CarroCargaEquipaje (IDcarro));